      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold tracking- mb-4">
              How It Works
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {
              howItWorks.map((item, index) => {
                return (
                  <div key={index}
                    className="flex items-center flex-col text-center space-y-4"
                  >
                      ...
                      <div className="flex flex-col space-y-4">
                        <div className="flex items-center space-x-4">
                          <div className="relative h-12 w-12 flex-shrink-0">
                            <Image
                              ...
                              width={40}
                              height={40}
                              className="rounded-full object-contain border-2 border-primary/20"
                            />
                          </div>
                          <div>
                        ...
                        <blockquote>
                          <p className="text-muted-foreground italic relative">
                            ...
                            {testimonial.quote}
                            <span className="text-3xl text-primary absolute -bottom-3">
                              &quot;
                            </span>
                          </p>
                        </blockquote>
